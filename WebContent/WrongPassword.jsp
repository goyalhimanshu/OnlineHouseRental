...
<p>&nbsp;</p>
  ...
  <body>
    ...
    <div id="container">    
    <br><br>
    <center><h2><font color='red' >Email not registered. Try Again.</font></h2></center>
    ...
    <tr>
      <td>
		  <fieldset><legend>Forgot Password?</legend><table width="553" border="0" align="center" cellpadding="1" cellspacing="1">
			...
			<tr>
			  <td colspan="2"><center><button type="submit" class="btn btn-default">Submit</button></center></td>
		    </tr>
		  </table>
		  </fieldset>
	 </td>
