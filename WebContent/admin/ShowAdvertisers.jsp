...
<tr>
  <td>
    ...
    <tbody>
	<%
		String postid="",username="",email="";
		Connection con=DBInfo.getConnection();
		String query="select distinct username from house;";
	...
	<tr>
		...
		<td align="center"><a href="DeleteAdvertiser.jsp?username=<%=username%>"class="btn btn-danger btn-md" data-toggle="tooltip" title="Delete Advertiser with all his posts"><span class="glyphicon glyphicon-remove">&nbsp;Delete</a></td>
	</tr>
	<script>
