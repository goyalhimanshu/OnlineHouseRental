...
<jsp:useBean id="obj" class="p1.FeedbackBean">
...
<p>&nbsp;</p>
			...
			%>
			<center><h2><p class="text-success"><span class="glyphicon glyphicon-ok"></span>&nbsp;Your Feedback Matters For Us.<br>Thank you.</p></h2><br>
