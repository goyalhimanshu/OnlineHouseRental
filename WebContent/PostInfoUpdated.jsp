...
<%@page import="p1.UpdatePostInfoBean"%>


<jsp:useBean id="obj" class="p1.UpdatePostInfoBean">
...
<%
	...
	int i=obj.updatePostInfo(amenities);
 %>
...
<center>
    		<h3><p class="text-success"><span class="glyphicon glyphicon-ok"></span>&nbsp;Add Successfully Updated.</p></h3><br>
    		<a href="Home.jsp" class="btn btn-info btn-lg"><span class="glyphicon glyphicon-home">&nbsp;Home</a>
    	</center>
